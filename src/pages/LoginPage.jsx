  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.card} className="kb-card">
        ...
        <p style={styles.subtitle}>Sign in to manage your parties</p>
        ...
        >
          ...
          <span style={{ marginLeft: 10 }}>{googleLoading ? 'Signing in…' : 'Continue with Google'}</span>
        </button>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div className="kb-field">
            <label className="kb-label" htmlFor="login-email">Email</label>
            <input
              id="login-email"
              type="email"
              className="kb-input"
          ...
          <div className="kb-field">
            <label className="kb-label" htmlFor="login-password">Password</label>
            <input
              id="login-password"
              type="password"
              className="kb-input"
